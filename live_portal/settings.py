"""
Django settings for live_portal project.
...
SECRET_KEY = 'oe92)gc=1*x)o^2y+ic7@8&$i7h^ub64*6lcso^0=s58lbdog5'
...
WSGI_APPLICATION = 'live_portal.wsgi.application'
...
UCALLER_ID = 102227
UCALLER_SECRET_KEY = 'Se3BFNKgM01PbiLs6T2hNoxOotNNJbCr'
